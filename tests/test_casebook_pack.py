"""Regression checks for the notion-mob-offline-lens casebook."""
...
from casebook.harness import assert_expected, notion_mob_offline_lens_summary
...
class CasebookTests(unittest.TestCase):
    ...
    def test_named_summary_alias(self) -> None:
        self.assertEqual(notion_mob_offline_lens_summary(), assert_expected())
